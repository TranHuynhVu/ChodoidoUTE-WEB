    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CountPost = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    ProductLost = table.Column<long>(type: "bigint", nullable: true),
                    ProductSuccess = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMissionDefault = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostProductStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissionDetail_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionDetail_Missions_MissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDetail_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceDetail_ServicePackage_ServicePackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeBuy = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buys_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsVideo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsVideo_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionDetail_MissionId",
                table: "MissionDetail",
                column: "MissionId");

            migrationBuilder.CreateIndex(
                name: "IX_MissionDetail_UserId1",
                table: "MissionDetail",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsVideo_ProductId",
                table: "ProductsVideo",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetail_ServicePackageId",
                table: "ServiceDetail",
                column: "ServicePackageId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetail_UserId1",
                table: "ServiceDetail",
                column: "UserId1");
        }
