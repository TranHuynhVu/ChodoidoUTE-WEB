...
namespace ChodoidoUTE.Migrations
{
    ...
    [Migration("20241202111853_Updata_TinNhan")]
    partial class Updata_TinNhan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChodoidoUTE.Models.ChiTietTinNhan", b =>
                {
                    ...
                    b.HasIndex("TinNhanId2");

                    b.ToTable("ChiTietTinNhan");
                });
            ...
            modelBuilder.Entity("ChodoidoUTE.Models.ChiTietTinNhan", b =>
                {
                    ...
                    b.HasOne("ChodoidoUTE.Models.ChiTietTinNhan", "TinNhan")
                        .WithMany()
                        .HasForeignKey("TinNhanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChodoidoUTE.Models.TinNhan", null)
                        .WithMany("chiTietTinNhans")
                        .HasForeignKey("TinNhanId2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
